...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Setting::create(['slug' => 'app_title', 'value' => 'EK Softwares',]);
        ...
        Setting::create(['slug' => 'title', 'value' => 'EK Softwares',]);
        ...
        Setting::create(['slug' => 'meta_author', 'value' => 'eksoftwares',]);
        Setting::create(['slug' => 'meta_description', 'value' => 'EK Softwares',]);
        ...
        Setting::create(['slug' => 'email', 'value' => 'support@eksoftwaress.com',]);
